...
def lista_produtos():
    ...
    tview = ttk.Treeview(lista_produtos, columns=("ID","Nome", "Descrição", "Embalagem","Valor"), show='headings')
    ...
    tview.column('Valor', minwidth=0, width=10)
    ...
    tview.pack(padx=10, ipadx=150,ipady=180,pady=140, anchor='n')
    ...
    def add_produto_estoque():
        ...
        try:
            ...
            session.rollback()
            showinfo("Erro: Estoque", f"Erro inesperado: {str(e)}")
