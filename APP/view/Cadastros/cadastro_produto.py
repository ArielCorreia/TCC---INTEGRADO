...
def cadastro_produto():
    ...
    #Texto
    Label(cadastro_produto, text="Descrição do Produto:", background="#dde",anchor="w").place(x=10, y= 95, width=120, height=20)
    ds_produto_entry = Entry(cadastro_produto)
    ds_produto_entry.place(x=150, y= 95, width=400, height=20)

    Label(cadastro_produto, text="Valor do Produto:", background="#dde", anchor="w").place(x=10, y=125, width=110, height=20)
    # Campo de preenchimento (entrada)
    valor_produto_entry = Entry(cadastro_produto) 
    valor_produto_entry.place(x=150, y= 125, width=50, height=20)   
    ...
    def registro_produto_BD():
        ...
        valor_produto = float(valor_produto_entry.get())

        #Criar uma nova instancia de produto
        novo_produto = Produto(nm_produto = nome_produto, tp_embalagemproduto = tipo_embalagem, ds_produto = descricao_produto, vl_produto= valor_produto)
